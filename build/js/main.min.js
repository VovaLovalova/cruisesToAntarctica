...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var form = document.querySelector('form[name="booking-form"]');
  var erorrCheckbox = document.createElement('div');
  ...
  if (checkbox) {
    var onCheckboxLabelKeydown = function onCheckboxLabelKeydown(e) {
